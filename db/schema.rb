...
ActiveRecord::Schema.define(version: 20170501161509) do
  ...
  create_table "products", force: :cascade do |t|
    ...
    t.datetime "created_at",         null: false
    t.datetime "updated_at",         null: false
    t.string   "p_img_file_name"
    t.string   "p_img_content_type"
    t.integer  "p_img_file_size"
    t.datetime "p_img_updated_at"
  end
